...
let ProductsController = class ProductsController {
    ...
    _assertAdminOrNsm(businessRole, organizationRole, platformRole) {
        const allowed = ['NSM', 'ADMIN', 'SUPER_ADMIN', 'OWNER', 'ADMIN'];
        if (platformRole === 'SUPER_ADMIN' ||
            allowed.includes(businessRole) ||
            allowed.includes(organizationRole))
            return;
        throw new common_1.ForbiddenException('Seuls les managers (NSM) et administrateurs peuvent gérer les matériaux promotionnels');
    }
};
...
__decorate([
    (0, common_1.Post)(),
    (0, roles_decorator_1.Roles)('NSM', 'ADMIN', 'SUPER_ADMIN'),
