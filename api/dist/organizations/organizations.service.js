...
exports.OrganizationsService = exports.CreateOrganizationDto = void 0;
    ...
    async findOne(id) {
        return this.prisma.organization.findUnique({
            ...
            include: {
                ...
                Team: { include: { OrganizationUser_Team_managerIdToOrganizationUser: { include: { User: { select: { firstName: true, lastName: true } } } } } },
                Sector: true,
            },
        });
    }
    async create(dto) {
        return this.prisma.organization.create({ data: { ...dto, updatedAt: new Date() } });
    }
    async update(id, dto) {
        return this.prisma.organization.update({ where: { id }, data: { ...dto, updatedAt: new Date() } });
    }
};
