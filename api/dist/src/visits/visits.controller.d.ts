import { VisitsService, CreateVisitDto, UpdateVisitDto, ValidateVisitDto, SubmitReportDto } from './visits.service';
export declare class VisitsController {
    ...
    teamDelegates(orgUserId: string, orgId: string): Promise<any>;
    pendingCount(orgUserId: string, orgId: string, businessRole: string): Promise<{
        count: number;
    }>;
