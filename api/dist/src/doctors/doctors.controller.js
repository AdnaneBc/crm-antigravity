...
let DoctorsController = class DoctorsController {
    ...
    _assertAssistantOrAdmin(businessRole, organizationRole, platformRole) {
        if (platformRole === 'SUPER_ADMIN' ||
            ...
            return;
        throw new common_1.ForbiddenException('Seuls les assistants et administrateurs peuvent gérer les médecins');
    }
};
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], DoctorsController.prototype, "getSectors", null);
__decorate([
    (0, common_1.Get)(':id'),
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [doctors_service_1.CreateDoctorDto, String, String, String, String]),
    __metadata("design:returntype", void 0)
